...
st.text("В датасете собраны химические и физические величины разных сортов вин, \nвыжатых из винограда из примерно одной области, а также оценка дегустации")
...
st.dataframe(load_wineset().describe().drop("count"))